...
tbl.SetLocale = function(locale)
	...
	if locale == "enUS" then -- English (US)
		...
		GlobalStrings["ADDON_NAME"] 							= "|cffCCA6F0" .. addon .. "|r: ";
		GlobalStrings["ADDON_NAME_SETTINGS"] 					= "|cffCCA6F0" .. addon .. "|r";
		GlobalStrings["COMMAND_DISCORD"]						= "discord";
		GlobalStrings["COMMAND_HISTORY"]						= "history";
		GlobalStrings["CURRENT"]								= "|cffffffffCurrent|r: ";
		GlobalStrings["DATE"]									= date("%m/%d/%Y");
		GlobalStrings["DISABLED"]								= "|cffffffffCurrent State|r: Disabled";
		GlobalStrings["ENABLED"]								= "|cffffffffCurrent State|r: Enabled";
